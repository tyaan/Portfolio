  ...
  return (
    <div className="project-card-floating">
      <div className="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 md:w-1/2 mx-auto my-8 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row">
            <img className="h-52 rounded-lg" src={project.imgURL} alt={project.title} />
            <div className="p-4 m-4">
              ...
              <br />
              <p className="text-md text-red-400 font-bold">{`${project.tech.join(", ")}`}</p>
            </div>
          </div>
